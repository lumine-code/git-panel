...
// The status bar tile carries the sync (fetch/pull/push) controls and the
// changed-files count. Branch display and switching live in the git-center
// package, so this tile no longer renders a branch view or branch menu.
export default class StatusBarTileController extends React.Component {
  ...
  handleOpenGitTimingsView = (e) => {
    e && e.preventDefault();
    this.props.workspace.open("lumine-github://debug/timings");
  };
