...
export default class CommitDetailItem extends React.Component {
  static uriPattern = "lumine-github://commit-detail?workdir={workingDirectory}&sha={sha}";

  static buildURI(workingDirectory, sha) {
    return `lumine-github://commit-detail?workdir=${encodeURIComponent(workingDirectory)}&sha=${encodeURIComponent(sha)}`;
  }
