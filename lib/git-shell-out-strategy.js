...
export default class GitShellOutStrategy {
  ...
  // repository creation/discovery (init/clone/rev-parse) and by specs; every
  // data read goes through the typed core APIs instead. Color is disabled here
  // because the raw exec path does not apply the worker's color config.
