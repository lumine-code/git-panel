...
export default class BranchMenuView extends React.Component {
  ...
  render() {
    ...
    let currentBranchName = this.props.currentBranch.isDetached()
      ? "detached"
    ...
    const branchEditorClasses = cx(
      "git-panel-BranchMenuView-item",
      "git-panel-BranchMenuView-editor",
      {
    ...
    const branchSelectListClasses = cx(
      "git-panel-BranchMenuView-item",
      "git-panel-BranchMenuView-select",
      "input-select",
      {
        hidden: !!this.state.createNew,
      },
    ...
    const iconClasses = cx("git-panel-BranchMenuView-item", "icon", {
    ...
    const selectBranchView = (
      ...
      >
        {this.props.currentBranch.isDetached() && (
          <option key="detached" value="detached" disabled>
            {this.props.currentBranch.getName()}
          </option>
        )}
        {branchNames.map((branchName) => {
          return (
            <option key={`branch-${branchName}`} value={branchName}>
              {branchName}
            </option>
          );
        })}
    ...
    return (
      <div className="git-panel-BranchMenuView">
        <Commands
          registry={this.props.commands}
          target=".git-panel-BranchMenuView-editor atom-text-editor[mini]"
        >
        ...
        <div className="git-panel-BranchMenuView-selector">
          <span className={iconClasses} />
          {newBranchEditor}
          {selectBranchView}
          <button
            className="git-panel-BranchMenuView-item git-panel-BranchMenuView-button btn"
