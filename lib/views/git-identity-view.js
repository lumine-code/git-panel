    ...
    return (
      <div className="git-panel-GitIdentity">
        ...
        <div className="git-panel-GitIdentity-text">
          <LumineTextEditor mini placeholderText="name" buffer={this.props.usernameBuffer} />
          <LumineTextEditor mini placeholderText="email address" buffer={this.props.emailBuffer} />
        </div>
