...
export default class CommitView extends React.Component {
  static focus = {
    ...
    REMOTE_ACTION_BUTTON: Symbol("remote-action-button"),
  };
  ...
  constructor(props, context) {
    ...
    this.refRemoteActionButton = new RefHolder();
    ...
    return (
      <div className="git-panel-CommitView" ref={this.refRoot.setter}>
        ...
        <footer className="git-panel-CommitView-bar">
          ...
          <RemoteActionButton
            buttonRef={this.refRemoteActionButton}
            ...
            isPulling={this.props.isPulling}
            isPushing={this.props.isPushing}
            disabled={this.props.isSwitchingRepository}
  ...
  getFocus(element) {
    ...
    if (this.refRemoteActionButton.map((e) => e.contains(element)).getOr(false)) {
      return CommitView.focus.REMOTE_ACTION_BUTTON;
    }
  ...
  setFocus(focus) {
    ...
    if (focus === CommitView.focus.REMOTE_ACTION_BUTTON) {
      if (this.refRemoteActionButton.map(focusElement).getOr(false)) {
        return true;
      }
      fallback = true;
    }
