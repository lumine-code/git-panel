...
export class Command extends React.Component {
  ...
  // is what puts the command's second line in the palette and in a picker's
  // item-actions list. A command whose derived label already says everything
  // passes none, and registers as the bare callback it always did.
