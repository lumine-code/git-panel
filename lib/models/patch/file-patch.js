...
export default class FilePatch {
  ...
  triggerCollapseIn(patchBuffer, { before, after }) {
    ...
    const { patchBuffer: subPatchBuffer, markerMap } = patchBuffer.extractPatchBuffer(oldRange, {
      exclude,
    });
    ...
    const patchMarker = patchBuffer.markPosition(Patch.layerName, insertionPosition, {
      invalidate: "never",
      exclusive: true,
    });
